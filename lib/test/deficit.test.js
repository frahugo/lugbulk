...
describe("deficit", function () {
  ...
  context("distributing discrepancy", function () {
    ...
    it("should round until none remains", function () {
      ...
      deficit.distributions[1].should.have.property("diff").and.equal(-2);
      deficit.distributions[1].should.have.property("quantityAfterAdjustment").and.equal(98);
      deficit.distributions[1].should.have.property("quantityToAddOrRemove").and.equal(-2);
      ...
      deficit.distributions[2].should.have.property("quantityAfterAdjustment").and.equal(99);
      deficit.distributions[2].should.have.property("quantityToAddOrRemove").and.equal(3);
    });
    ...
    it("should distribute in ascending order of quantity", function () {
      ...
      deficit.summaries[1].should.have.property("quantity").and.equal(100);
      deficit.summaries[1].should.have.property("adjustments").and.equal("-10, -10, -10");
      deficit.summaries[1].should.have.property("newQuantities").and.equal("90");
      deficit.summaries[2].should.have.property("quantity").and.equal(200);
      deficit.summaries[2].should.have.property("adjustments").and.equal("-21, -22");
      deficit.summaries[2].should.have.property("newQuantities").and.equal("179, 178");
      deficit.summaries[3].should.have.property("quantity").and.equal(300);
      deficit.summaries[3].should.have.property("adjustments").and.equal("+78");
      deficit.summaries[3].should.have.property("newQuantities").and.equal("268");
    });
